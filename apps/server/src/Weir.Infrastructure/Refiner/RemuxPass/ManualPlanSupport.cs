...
public static class ManualPlanSupport
{
    ...
    public static RefinerJob EnqueueManualPlan(
        UnitOfWork uow, RefinerJobStore jobs, ManualPlanFileContext context, ManualPlanChoice choice, SourceFingerprint fingerprint)
    {
        ArgumentNullException.ThrowIfNull(uow);
