...
/// <summary>
/// "Why is this file held?" (port of <c>processing_hold_diagnostic_api.py</c>): ask every media manager
...
public static class HoldDiagnosticStore
{
    ...
    /// domain rules the watched-folder scan applies per file (port of <c>get_processing_file_why_held</c>).
