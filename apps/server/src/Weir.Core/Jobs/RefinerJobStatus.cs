...
/// <summary>
/// Values persisted in <c>refiner_jobs.status</c> (port of <c>weir.refiner.jobs_model.RefinerJobStatus</c>).
/// </summary>
/// <remarks>
...
/// </remarks>
public static class RefinerJobStatus
{
...
/// <summary>One <c>refiner_jobs</c> row as read from the database.</summary>
public sealed record RefinerJob(
    long Id,
    string DedupeKey,
    string JobKind,
    string? PayloadJson,
