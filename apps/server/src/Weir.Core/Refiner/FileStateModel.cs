...
/// <summary>
/// The vocabulary an operator sees on the Files screen (<c>RefinerFileStatus</c>).
...
/// </summary>
public static class RefinerFileStatuses
{
...
/// <summary>One <c>refiner_files</c> row.</summary>
public sealed record RefinerFileRecord
{
    public long Id { get; init; }
    public long LibraryId { get; init; }
    public required string RelativePath { get; init; }

    public string Status { get; init; } = RefinerFileStatuses.Unprocessed;
...
public sealed record RefinerFileListFilter
{
    public long? LibraryId { get; init; }
