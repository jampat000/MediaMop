...
/// <summary>Discovery could not run, with an operator-readable reason (<c>RefinerDiscoveryError</c>).</summary>
public sealed class RefinerDiscoveryException : Exception
{
    public RefinerDiscoveryException(string message)
        : base(message)
    {
    }
}
...
/// <summary>
/// The pure, path-shape half of <c>refiner_library_discovery</c> (port). The filesystem check
