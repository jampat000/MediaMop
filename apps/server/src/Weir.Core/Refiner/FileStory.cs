...
/// <summary>How a story step should read (not a severity) — <c>Tone</c> in <c>refiner_file_story.py</c>.</summary>
...
/// <summary>
/// Tell the story of what happened to a file, in plain language (port of <c>refiner_file_story.py</c>, #468).
/// Narrated at read time from the stored <c>refiner_file_logs.detail_json</c> payload; never raises on a
