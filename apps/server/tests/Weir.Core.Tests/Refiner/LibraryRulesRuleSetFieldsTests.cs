...
/// <see cref="RefinerRuleSetRecord"/>, and validates the track name template/overrides the same way the engine
...
public sealed class LibraryRulesRuleSetFieldsTests
{
    ...
    {
        var row = LibraryRules.ApplyRuleSetFields(new RefinerRuleSetRecord { Name = "Test" }, ValidInput());
    ...
    {
        var row = LibraryRules.ApplyRuleSetFields(new RefinerRuleSetRecord { Name = "Test" }, new LibraryRules.RuleSetInput { Name = "Test" });
    ...
    public void An_unknown_placeholder_in_the_main_template_is_refused()
    {
        ...
        var exception = Assert.Throws<RefinerLibraryException>(() =>
            LibraryRules.ApplyRuleSetFields(new RefinerRuleSetRecord { Name = "Test" }, input));
    ...
    public void A_default_template_and_overrides_never_throw() =>
        LibraryRules.ApplyRuleSetFields(new RefinerRuleSetRecord { Name = "Test" }, new LibraryRules.RuleSetInput { Name = "Test" });
}
