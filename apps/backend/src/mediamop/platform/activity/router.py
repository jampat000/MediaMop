...
def get_activity_export(
    ...
    headers = {"X-MediaMop-Export-Limit": str(EXPORT_MAX_ROWS), "X-MediaMop-Export-Rows": str(len(records))}
    if export_format == "json":
        headers["Content-Disposition"] = f'attachment; filename="mediamop-activity-{stamp}.json"'
        return Response(
    ...
    headers["Content-Disposition"] = f'attachment; filename="mediamop-activity-{stamp}.csv"'
