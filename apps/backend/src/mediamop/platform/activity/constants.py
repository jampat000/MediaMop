...
PRUNER_PLEX_LIVE_LIBRARY_REMOVAL_COMPLETED = "pruner.plex_live_library_removal_completed"
PRUNER_PLEX_LIVE_LIBRARY_REMOVAL_FAILED = "pruner.plex_live_library_removal_failed"
