...
from mediamop.modules.subber.subber_library_sync_job_handler import register_library_sync_handlers
...
def build_subber_job_handlers(
    ...
    reg.update(register_library_sync_handlers(settings, session_factory))
