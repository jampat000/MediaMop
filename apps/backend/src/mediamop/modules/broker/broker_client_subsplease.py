"""SubsPlease RSS native indexer client."""
...
class BrokerClientSubsplease(BrokerClientBase):
    slug = "native__subsplease"
    protocol = "torrent"
    display_name = "SubsPlease"
    ...
    async def search(
        ...
        url = f"https://subsplease.org/rss/?s={q}&r=1080" if q else "https://subsplease.org/rss/?t&r=1080"
    ...
    async def test(self, api_key: str = "", base_url: str = "") -> bool:
        _ = api_key, base_url
        raw = await self._get_bytes("https://subsplease.org/rss/?t&r=1080")
