"""TorLock RSS native indexer client."""
...
class BrokerClientTorlock(BrokerClientBase):
    slug = "native__torlock"
    protocol = "torrent"
    ...
    async def search(
        ...
        url = f"https://www.torlock.com/all/torrents/{q}.rss"
    ...
    async def test(self, api_key: str = "", base_url: str = "") -> bool:
        _ = api_key, base_url
        raw = await self._get_bytes("https://www.torlock.com/all/torrents/test.rss")
