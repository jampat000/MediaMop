"""Tokyo Toshokan RSS native indexer client."""
...
class BrokerClientTokyotoshokan(BrokerClientBase):
    slug = "native__tokyotoshokan"
    protocol = "torrent"
    ...
    async def search(
        ...
        url = f"https://www.tokyotosho.info/rss.php?search={q}&type=1"
    ...
    async def test(self, api_key: str = "", base_url: str = "") -> bool:
        _ = api_key, base_url
        raw = await self._get_bytes("https://www.tokyotosho.info/rss.php?search=test&type=1")
