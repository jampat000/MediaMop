"""Nyaa.si RSS native indexer client."""
...
class BrokerClientNyaa(BrokerClientBase):
    slug = "native__nyaa"
    protocol = "torrent"
    display_name = "Nyaa"
    ...
    async def search(
        ...
        url = f"https://nyaa.si/?page=rss&q={q}&c=0_0&f=0"
    ...
    async def test(self, api_key: str = "", base_url: str = "") -> bool:
        _ = api_key, base_url
        raw = await self._get_bytes("https://nyaa.si/?page=rss&q=test&c=0_0&f=0")
