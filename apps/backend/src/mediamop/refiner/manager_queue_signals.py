...
:mod:`mediamop.refiner.domain` decides *whether* a row blocks a file. It has no
...
from mediamop.refiner.queue_adapter import map_queue_row_to_refiner_view, queue_dialect_for_scope
