...
from mediamop.refiner.direct_play import load_device_profiles
from mediamop.refiner.direct_play.service import (
...
def _out(db: Session, settings: MediaMopSettings) -> DirectPlayDevicesOut:
    ...
    return DirectPlayDevicesOut(
        devices=[
            ...
            for p in load_device_profiles(settings.mediamop_home)
        ],
