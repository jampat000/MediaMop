...
class RefinerFileStatus(StrEnum):
    ...
    # Terminal, and deliberately distinct from PROCESSED: Weir could not process this file,
    ...
    # by the manager or, for a hand-off, by Weir once the report was accepted.
    REJECTED = "rejected"


#: States where Weir has decided not to act, as opposed to not having acted yet.
