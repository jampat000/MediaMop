...
class RefinerLibraryRow(Base):
    ...
    # Hardware decoding. Off by default, which is exactly what Weir does today by not
    ...
    # What happens once retries are exhausted (#465). Weir sits in the middle of someone
