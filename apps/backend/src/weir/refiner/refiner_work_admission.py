...
from weir.platform.media_managers.schedule_wall_clock import schedule_time_window_active
...
from weir.refiner.refiner_runner_units import RunnerBudget, budget_from_settings
from weir.refiner.refiner_schedule_grid import grid_allows, next_open_slot
...
class PauseState:
    ...
    def reason(self) -> str:
        ...
        return "Processing is paused. Weir will start work again when you resume it."
