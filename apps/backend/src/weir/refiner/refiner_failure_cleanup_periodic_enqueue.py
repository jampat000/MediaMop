...
from weir.refiner.refiner_failure_cleanup_activity import record_refiner_failure_cleanup_sweep_skipped
...
_FAILURE_CLEANUP_KILL_SWITCH_VARIABLE = "WEIR_REFINER_MOVIE_FAILURE_CLEANUP_SCHEDULE_ENABLED"


def _failure_cleanup_enabled(session_factory: sessionmaker[Session], settings: WeirSettings) -> bool:
