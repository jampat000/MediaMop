...
_ENV_KILL_SWITCH_VARIABLE = {
    "work_temp_stale_sweep_enabled": "WEIR_REFINER_WORK_TEMP_STALE_SWEEP_MOVIE_SCHEDULE_ENABLED"
}


def _sweep_enabled(session_factory: sessionmaker[Session], settings: WeirSettings, *, attribute: str) -> bool:
