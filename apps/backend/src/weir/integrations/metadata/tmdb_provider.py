...
from weir.platform.outbound_http import validate_external_provider_url
...
class TmdbMetadataProvider:
    ...
    def _search(self, params: dict[str, str], *, subject: str, use_rate_limit: bool = True) -> LookupResult:
        ...
        try:
            ...
            return LookupResult(status="unreachable", detail=f"Weir could not reach the metadata provider ({exc}).")
