"""Media managers: the products Weir takes work from and reports back to.
...
from weir.platform.media_managers.handoff_paths import (
    HandoffPathResult,
...
from weir.platform.media_managers.manager_dialects import capabilities_for_kind, port_for_kind
