...
from weir.platform.activity.service import prune_activity_events
from weir.platform.media_managers.handoff_ledger import prune_ledger
...
def _run_prune_tick(session_factory: sessionmaker[Session], *, settings: WeirSettings) -> dict[str, int]:
