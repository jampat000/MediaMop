...
from weir.platform.metrics.service import record_http_request

logger = logging.getLogger(__name__)
_request_id_var: ContextVar[str | None] = ContextVar("weir_request_id", default=None)
_job_id_var: ContextVar[str | None] = ContextVar("weir_job_id", default=None)
