...
# A file Weir could not process was handed back unmodified rather than kept (#465). A distinct
...
# The opt-in reject policy: the manager accepted the report, or Weir fell back to handing the
...
# The manager cancelled a hand-off Weir had not started (#480).
