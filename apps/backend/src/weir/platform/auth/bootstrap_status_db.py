...
with operator-facing copy (migrations, ``WEIR_HOME``), not **500**.
"""
...
_DB_UNAVAILABLE = "SQLite database unavailable or cannot be opened (check WEIR_HOME and WEIR_DB_PATH)."
_QUERY_FAILED = (
