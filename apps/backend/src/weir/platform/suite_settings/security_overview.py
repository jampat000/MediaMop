"""Plain-language security snapshot from :class:`~weir.core.config.WeirSettings` (startup only)."""

from __future__ import annotations

from weir.core.config import WeirSettings
from weir.platform.suite_settings.schemas import SuiteSecurityOverviewOut
...
def build_suite_security_overview(settings: WeirSettings) -> SuiteSecurityOverviewOut:
