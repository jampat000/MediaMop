...
import type {
  RefinerDirectPlay,
  RefinerDirectPlayVerdict,
} from "../../lib/refiner/files-api";

const SYMBOL: Record<RefinerDirectPlayVerdict, string> = {
  yes: "✓",
  no: "✗",
  maybe: "?",
  unknown: "",
...
const WORD: Record<RefinerDirectPlayVerdict, string> = {
  yes: "yes",
  no: "no",
  maybe: "maybe",
...
const SENTENCE: Record<Exclude<RefinerDirectPlayVerdict, "unknown">, string> = {
...
function shortReason(entry: RefinerDirectPlay): string | null {
