...
Backend code should use `weir.platform.file_lifecycle.mutations` for final media file placement instead of direct `shutil.move`, direct final-path copies, or unlink-then-copy patterns.
