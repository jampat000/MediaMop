...
This hotfix keeps the Windows tray application and Weir server running when Windows cannot open the dashboard in a browser automatically.

## What Changed

- Opening the dashboard at startup is now treated as a convenience instead of a requirement.
- If Windows rejects the browser launch, Weir records a clear log message and continues running normally.
...
https://github.com/jampat000/Weir/compare/v2.6.1...v2.6.2
