...
Completes the update system introduced in v2.3.2 — tray modes now behave correctly, the Settings page exposes startup and interval controls, and double-clicking the tray icon opens Weir.
...
- **Tray icon double-click** opens Weir in the browser.
- **Docker update command** now shows the exact version tag to pull (e.g. `docker pull ghcr.io/jampat000/weir:2.3.3`).
...
- `ghcr.io/jampat000/weir:2.3.3`
- `ghcr.io/jampat000/weir:latest`

## Full Changelog

https://github.com/jampat000/Weir/compare/v2.3.2...v2.3.3
