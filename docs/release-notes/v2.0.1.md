...
This release focuses on reducing Windows install size by packaging only the FFmpeg tools Weir actually uses.

## What Changed

- Windows packaging now vendors only `ffmpeg.exe` and `ffprobe.exe`.
- `ffplay.exe` is no longer bundled in Weir Windows builds.
...
- `ghcr.io/jampat000/weir:v2.0.1`
- `ghcr.io/jampat000/weir:latest`

## Full Changelog

https://github.com/jampat000/Weir/compare/v2.0.0...v2.0.1
