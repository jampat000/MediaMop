...
- **Update mode selector**: Settings > Upgrade now shows a radio group (Auto / Download only / Notify only) on Windows installs. The chosen mode is written to `update-settings.json` in WEIR_HOME and picked up by the tray on its next update check.
...
- `ghcr.io/jampat000/weir:2.3.2`
- `ghcr.io/jampat000/weir:latest`

## Full Changelog

https://github.com/jampat000/Weir/compare/v2.3.1...v2.3.2
