...
- Activity history now reports Processing removals and Subber outcomes more accurately.
...
- Processing activity details no longer show `None removed` when audio or subtitle tracks were actually removed.
...
- Docker operators can now set `WEIR_PUID` / `WEIR_PGID` plus watched/temp/output ownership controls if the container should not write as root.

## Docker

- `ghcr.io/jampat000/weir:2.1.0`
- `ghcr.io/jampat000/weir:latest`

## Full Changelog

https://github.com/jampat000/Weir/compare/v2.0.7...v2.1.0
