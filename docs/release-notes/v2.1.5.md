...
- Fixed stale failed updater state remaining visible after Weir is already running the target version.
- Historical failed attempts are now archived once Weir proves the target version is already installed and healthy.
...
- [v2.1.4...v2.1.5](https://github.com/jampat000/Weir/compare/v2.1.4...v2.1.5)
