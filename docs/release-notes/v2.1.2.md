...
- Installer downloads remain tied to the trusted Weir release with checksum verification before execution.
...
- This release keeps the completion gate strict: Weir only reports the upgrade complete after the running version matches the target version.

## Docker

- `ghcr.io/jampat000/weir:2.1.2`
- `ghcr.io/jampat000/weir:latest`

## Full Changelog

https://github.com/jampat000/Weir/compare/v2.1.1...v2.1.2
