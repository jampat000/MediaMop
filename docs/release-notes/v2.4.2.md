...
- The web address and secret an app needs are now folded away under **"How to point &lt;app&gt; at Weir"**. You need them once while wiring things up, not every time you glance at the screen.
- The introduction no longer explains Radarr, Sonarr and Deluno in one breath, or name Weir's internal parts. It says what the screen is for.
...
- `ghcr.io/jampat000/weir:2.4.2`
- `ghcr.io/jampat000/weir:latest`

## Full Changelog

https://github.com/jampat000/Weir/compare/v2.4.1...v2.4.2
