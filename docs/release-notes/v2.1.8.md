...
- Fixed a Windows in-app upgrade regression where Weir could mark an upgrade as completed after the backend returned, even though the desktop tray app had not relaunched.
- Added a more reliable interactive-session relaunch fallback for the Weir tray host after silent upgrades.
...
[Full Changelog](https://github.com/jampat000/Weir/compare/v2.1.7...v2.1.8)
