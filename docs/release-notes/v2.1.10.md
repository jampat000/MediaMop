...
- The browser refresh only remains available after Weir has already proved the running version matches the upgrade target.
...
[Full Changelog](https://github.com/jampat000/Weir/compare/v2.1.9...v2.1.10)
