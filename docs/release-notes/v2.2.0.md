...
- Keep `WeirSetup.exe` and `WeirSetup.exe.sha256` together for release validation and support troubleshooting.

## Docker

- `ghcr.io/jampat000/weir:2.2.0`
- `ghcr.io/jampat000/weir:latest`

## Full Changelog

https://github.com/jampat000/Weir/compare/v2.1.13...v2.2.0
