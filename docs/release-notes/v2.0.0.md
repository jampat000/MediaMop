...
This release improves upgrade reliability, first-run/login flow, and overall day-to-day stability across Processing, Dashboard, and the Windows app.
...
- Processing no longer repeatedly remuxes the same file after a successful output when source cleanup temporarily fails due to a Windows/NAS file lock.
...
- `ghcr.io/jampat000/weir:v2.0.0`
- `ghcr.io/jampat000/weir:latest`

## Full Changelog

https://github.com/jampat000/Weir/compare/v1.0.33...v2.0.0
