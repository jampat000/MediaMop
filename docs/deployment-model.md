...
Module worker settings such as the Refiner worker count control in-process job slots inside the single application process. They do not make MediaMop multi-node safe.
